...
const BookSingleCard = ({ book }) => {
    ...
    return (
        <div key={book._id} className='border-2 border-slate-gray-500 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl'>
            <h2 className='absolute top-1 right-2 px-2 py-1 bg-red-300 rounded-lg'>{book.publishYear}</h2>
